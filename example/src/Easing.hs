...
data EasingDemo
data instance PageState EasingDemo = Easings [Easing]
...
type PageState' = PageState EasingDemo
type AnimState = AnimationState EasingDemo

initialPageState :: PageState'
initialPageState = Easings easings
...
transition :: PageState'
           -> Transition
           -> (PageState', [AnimConfig EasingDemo])
...
view :: PageState' -> React EasingDemo ()
